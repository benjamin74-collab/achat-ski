...
export default function EditCategoryForm({
  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-4">
      ...
      <div className="grid gap-1">
        <label className="text-sm">Image vignette homepage</label>
        <input
          type="text"
          name="thumbnailUrl"
        ...
        <p className="text-xs text-slate-500">
          Image utilisée dans le bloc “Catégories populaires” de la homepage.
        </p>
      </div>
      ...
      <div className="grid gap-1">
        ...
        <textarea
          name="aliases"
          rows={2}
          defaultValue={arrToLines(initial.aliases)}
          className="rounded-xl border border-ring px-3 py-2"
